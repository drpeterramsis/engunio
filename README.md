...
## Version 1.0.020 Updates
- **OpenRouter API Integration**: Switched from Google Gemini API to OpenRouter for more reliable question generation.
...
- **Version Update**: Updated application version to 1.0.020 across all configuration files and the UI footer.
